...
**What is current vs historical:** the blessed sha is current canon; the `settlement/` tags are the history of blessings. S16 at `9b1d765a` is current canon and the live site pin. World main is intentionally one post-bless parcel commit ahead at `8f8aa8c`; that input is not canon until a later green blessing carries it. A refused crossing creates no tag and does not advance canon. `memory/drain-manifest.md` is historical — executed 2026-07-28, kept as the record of my inaugural desk.
